...
// Import the Cognito context
import AWSCognitoContext from 'contexts/AWSCognitoContext'; // Adjust the path as necessary
...
export default function TabPassword() {
  ...
  const { changePassword } = useContext(AWSCognitoContext); // Consume the changePassword method
    ...
    <MainCard title="Change Password">
      <Formik
        ...
        onSubmit={async (values, { resetForm, setErrors, setStatus, setSubmitting }) => {
          try {
            await changePassword(values.old, values.password); // Call changePassword
